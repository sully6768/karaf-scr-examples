...
@Component(name = ManagedComponent.COMPONENT_NAME, 
...
public class ManagedComponent {
    ...
    public void activate(final Map<String, ?> properties) {
        ...
        simpleService.setName((String)properties.get(COMPONENT_PROP_NAME));
        simpleService.setSalutation((String)properties.get(COMPONENT_PROP_SALUTATION));
